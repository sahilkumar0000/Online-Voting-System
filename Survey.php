...
<html style="font-size: 16px;">
  <head>
    ...
    <link rel="stylesheet" href="Css/Survey.css" media="screen">
  ...
  <body class="u-body u-xl-mode"><header class="u-black u-clearfix u-header u-header" id="sec-3385"><div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1" data-href="index.php" data-page-id="50819088"><img src="images/unknown1.png" alt=""></span>
...
</li><li class="u-nav-item"><a class="u-active-custom-color-1 u-border-active-palette-1-base u-border-hover-palette-1-light-1 u-button-style u-hover-custom-color-1 u-nav-link u-text-active-white u-text-hover-white u-text-white" href="Logout.php" style="padding: 20px 22px;">Logout</a>
</li></ul>
          </div>
    ...
    <section class="u-clearfix u-gradient u-section-1" id="sec-8ae0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h1 class="u-custom-font u-font-raleway u-text u-text-default u-text-1">Survey</h1>
        <p class="u-text u-text-default u-text-2">Select the option you agree with&nbsp;</p>
        <div class="u-form u-form-1">
          <form method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px;">
            <div class="u-form-group u-form-select u-label-top u-form-group-1">
            <label for="select-537c" class="u-custom-font u-font-oswald u-label u-label-1">Name</label>
            <input type="text" placeholder="Enter your name" id="email-319a" name="name" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle" value="<?php echo $_SESSION['user_name']; ?>" readonly required="">
              <label for="select-537c" class="u-custom-font u-font-oswald u-label u-label-1">How's your experience in CU</label>
              <div class="u-form-select-wrapper">
                <select id="select-537c" name="option_a" value="option_a" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle">
            ...
            <div class="u-form-group u-form-select u-label-top u-form-group-2">
              <label for="select-f121" class="u-custom-font u-font-oswald u-label u-label-2">How's your experience with the faculty</label>
              <div class="u-form-select-wrapper">
                <select id="select-f121" name="option_b" value="option_b" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle">
                <option value="None">None</option> 
                <option value="Satisfied">Satisfied</option>
                  <option value="Neutral">Neutral</option>
                  <option value="Not Satisfied">Not Satisfied</option>
            ...
            <div class="u-form-group u-form-select u-label-top u-form-group-3">
              <label for="select-91ef" class="u-custom-font u-font-oswald u-label u-label-3">How's your experience in the campus </label>
              <div class="u-form-select-wrapper">
                <select id="select-91ef" name="option_c"  value="option_c" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle">
                <option value="None">None</option>   
                <option value="Satisfied">Satisfied</option>
                  <option value="Neutral">Neutral</option>
                  <option value="Not Satisfied">Not Satisfied</option>
            ...
            <div class="u-form-group u-form-select u-label-top u-form-group-4">
              <label for="select-7d70" class="u-custom-font u-font-oswald u-label u-label-4">How's your experience with DSW</label>
              <div class="u-form-select-wrapper">
                <select id="select-7d70" name="option_d" value="option_d" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle">
                <option value="None">None</option>   
                <option value="Satisfied">Satisfied</option>
                  <option value="Neutral">Neutral</option>
                  <option value="Not Satisfied">Not Satisfied</option>
            ...
            <div class="u-form-group u-form-select u-label-top u-form-group-5">
              <label for="select-c028" class="u-custom-font u-font-oswald u-label u-label-5">How's your experience with the hostel staff</label>
              <div class="u-form-select-wrapper">
                <select id="select-c028" name="option_e" value="option_e" class="u-border-2 u-border-palette-2-base u-grey-80 u-input u-input-rectangle">
                <option value="None">None</option>   
                <option value="Satisfied">Satisfied</option>
                  <option value="Neutral">Neutral</option>
                  <option value="Not Satisfied">Not Satisfied</option>
            ...
            <button type="submit" name="surveyb" class="u-black u-border-2 u-border-custom-color-1 u-border-hover-grey-90 u-btn u-btn-round u-button-style u-hover-white u-radius-50 u-btn-1">SUBMIT</button>
                   
            </div>
            </form>
            <?php
  if(isset($_POST['surveyb'])) {
    ...
    $user_name= $_SESSION['user_name'];
      $select="SELECT * from survey_tbl where user_name='$user_name'";
      $exe1=$conn->query($select);
      if($exe1->num_rows>0) {
          echo "<div class='lol-ag'><h4>You Have Already Submiited : <a href='welcome.php'>CLICK HERE</a> </h4></div>";}
          else {
            $insert="INSERT INTO survey_tbl (user_name,option_a,option_b,option_c,option_d,option_e) values('$user_name','$option_a','$option_b','$option_c','$option_d','$option_e')";
            $run=$conn->query($insert);
                  if($run){
                      echo "<div class='lol-ag'><h4>You Have Successfully Submiited... </h4></div>";
                  }
                  else {
                      echo "<div class='lol-ag'><h4>Your Survey Was Not Submitted...</h4></div>";
                  }
