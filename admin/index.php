...
if(isset($_POST['login'])){
	...
	$select="SELECT * from admin_user where user_email='$user_email' and user_password='$user_password'";
...
?>
  <body class="u-body u-xl-mode"><header class="u-black u-clearfix u-header u-header" id="sec-3385"><div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1" data-href="index.php" data-page-id="50819088"><img src="../images/unknown1.png" alt=""></span>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Vote.php">Result</a>
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="Survey.php">Survey Result</a>
    ...
    <section class="u-align-center u-clearfix u-gradient u-section-1" id="sec-d3f4">
      <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"><img src="../images/925816016s1.png" alt=""></span>
        <h1 class="u-custom-font u-font-raleway u-text u-text-default u-text-1">Admin Log <span style="font-size: 3.75rem;"></span>In
        </h1><span class="u-file-icon u-icon u-icon-rectangle u-icon-2"><img src="../images/1057028.png" alt=""></span>
        <div class="u-black u-border-2 u-border-custom-color-1 u-form u-radius-10 u-form-1">
          <form method="POST" class="u-clearfix u-form-spacing-30 u-form-vertical u-inner-form" style="padding: 50px;">
            ...
            <div class="u-form-group u-form-name u-form-group-2">
              <label for="name-319a" class="u-label u-text-body-alt-color u-label-2">Password</label>
              <input type="password" placeholder="Enter your Name" id="name-319a" name="password" class="u-border-3 u-border-no-left u-border-no-right u-border-no-top u-border-white u-input u-input-rectangle" required="">
            </div>
            <div class="u-align-left u-form-group u-form-submit u-form-group-3">
              <button type="submit" class="u-active-palette-2-light-2 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-2-light-2 u-radius-8 u-text-palette-2-base u-white u-btn-1" name="login">Login In </button>
            </div>
          </form>
