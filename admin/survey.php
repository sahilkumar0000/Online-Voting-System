  ...
  <body class="u-body u-xl-mode"><header class="u-black u-clearfix u-header u-header" id="sec-3385"><div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1" data-href="index.php" data-page-id="50819088"><img src="../images/unknown1.png" alt=""></span>
   ...
   <section class="u-align-center u-clearfix u-gradient u-section-1" id="carousel_c03c">
        <div class="u-clearfix u-sheet u-sheet-1">
          <h2 class="u-text u-text-black u-text-default u-text-1">Survey Result</h2>
       ...
       $prj= mysqli_query($conn,"SELECT * FROM survey_tbl") or die(mysqli_error($conn));
               $record = array();
            ...
            <div class="u-repeater-1">
              ...
              <table class="border: 1px solid black;">
                <div class="u-container-layout u-similar-container u-container-layout-1">
                  ...
                  <tr>
                      <th>Name</th>
                      <th>Experience in CU</th>
                      <th>Experience with faculty</th>
                      <th>Experience in campus</th>
                      <th>Experience with DSW</th>
                      <th>Experience with hostel staff</th>

       </tr>
       <tr>
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['user_name'];?></h5> </td> 
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['option_a'];?></h5> </td> 
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['option_b'];?></h5> </td> 
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['option_c'];?></h5> </td> 
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['option_d'];?></h5> </td> 
                        <td> <h5 class="u-align-left u-text u-text-black u-text-lol"><?php echo $rec['option_e'];?></h5> </td> 
       </tr>
